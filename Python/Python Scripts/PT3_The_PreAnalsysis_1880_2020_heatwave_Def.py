...
Max_7Day_Roll = Max_Min_Perth_NaN_To_Large['maximum temperature (degC)'].rolling(7,center = True).mean()
Min_7Day_Roll = Max_Min_Perth_NaN_To_Large['minimum temperature (degC)'].rolling(7,center = True).mean()
